    ...
    return (
        <div className='max-w-7xl m-auto px-5 lg:px-4 pb-6' ref={ref}>
            <div className='relative mb-12'>
                ...
                <div className='bg-[#a435f0] dark:bg-[#3c4371] rounded text-white w-2/3 -mt-24 z-10 relative m-auto px-10 py-20 text-center'>
                    <h1 className='text-3xl font-bold course-title custom-brder relative  mb-4 pb-4'>{courseName}</h1>
            ...
            <div className='border rounded max-w-5xl m-auto font-bold p-12 text-black mt-6 dark:text-white'>
