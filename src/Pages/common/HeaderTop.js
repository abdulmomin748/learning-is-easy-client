    ...
    return (
        ...
        <div className='bg-base-200'>
            <div className='hdr-top flex justify-between items-center py-2 max-w-7xl m-auto px-4'>
                <div className='hdr-lft flex text-white'>
                        ...
                        <div className='flex items-center'>
                            <span className='border flex justify-center items-center px-2 py-1 mr-2 rounded text-sm'><FontAwesomeIcon  icon={faEnvelope} /></span>
                            <a className='text-sm' href="mailto:example@yourdomain.com">+11 ( 223 ) 4569example@yourdomain.com</a>
                        </div>
                    </div>  
                <div className='hdr-rgt flex'>
                            ...
                            <div> 
                                <button htmlFor="my-modal-4" className='px-5 ml-4 py-2 font-semibold rounded bg-blue-500 text-white'>Booking Form</button>
                            </div>
                </div>
            </div>
        </div>
