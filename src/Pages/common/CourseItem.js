...
const CourseItem = ({courseItem}) => {
    ...
    return (
        <>
            <Link to={`/courses/courseDetails/${id}`} rel="noopener noreferrer" href="#" className="max-w-sm border-2 rounded border-gray-300 mx-auto group hover:no-underline focus:no-underline dark:bg-gray-900 text-black">
