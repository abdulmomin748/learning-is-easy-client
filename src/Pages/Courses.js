        ...
        <div className='max-w-7xl m-auto px-4 py-24'>
            <div className="max-w-sm gap-3 mx-auto sm:max-w-full lg:grid lg:grid-cols-12 bg-gray-200 rounded dark:bg-gray-800 mb-16">
                ...
                <div className="p-6 space-y-2 lg:col-span-5 flex flex-col justify-center text-black ">
                    <h3 className="text-2xl dark:text-white font-semibold sm:text-4xl group-hover:underline group-focus:underline">Learning that gets you</h3>
            ...
            <div className=''>
                <h2 className='mb-8 pb-4 page-title text-4xl font-bold text-black dark:text-white relative custom-brder'>Most Viewing Tutorails in last Fiew Year!!</h2>
                <div className='rounded flex'>
                    ...
                    <div className='w-1/4  text-black rounded'>
                        <div className='bg-gray-200 dark:bg-gray-800 dark:text-white rounded px-3 py-10'>
                        {
